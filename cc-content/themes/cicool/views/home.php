...
<body id="page-top" class="sidebar-mini fixed web-body <?=$skin;?>" style="background: url('<?=base_url()?>setting/<?=get_option('background')?>'); background-size: cover; background-repeat: no-repeat; background-position: center center; background-attachment: fixed;">
   <?= get_navigation(); ?>
