            ...
            <div class="box-body ">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="box box-widget widget-user" >
                      ...
                      <div class="widget-user-header " style="background: url('<?=base_url()?>setting/<?=get_option('background')?>') center center;">
                      ...
                      <div class="box box-widget widget-user-2">
                        ...
                        <div class="box-footer no-padding">
                          ...
                          <?php foreach($this->aauth->get_user_groups() as $row): ?>
                            <li><a href="#"><i class="fa fa-chevron-right"></i> <?php echo _ent($row->name." ");echo($row->name == 'RT' ? $user->rt : '') ?></a></li>
                           <?php endforeach; ?>
                          </ul>
                        </div>
                      </div>
