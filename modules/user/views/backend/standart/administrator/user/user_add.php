            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <?= form_open('', [
                    ...
                    <div class="form-group ">
                        <label for="full_name" class="col-sm-2 control-label"><?= cclang('nama lengkap') ?> <i class="required">*</i></label>
                    ...
                    <div class="form-group ">
                        <label for="rt" class="col-sm-2 control-label"><?= cclang('RT Berapa') ?> <i class="required">*</i></label>
                    ...
                    <div class="form-group ">
                        <label for="rw" class="col-sm-2 control-label"><?= cclang('RW Berapa') ?> <i class="required">*</i></label>
