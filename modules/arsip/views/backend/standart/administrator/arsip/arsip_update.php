            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/arsip/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_arsip', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="nama" id="nama" data-placeholder="Select Nama" >
                                    ...
                                    <option <?=  $row->nama_lengkap ==  $arsip->nama ? 'selected' : ''; ?> value="<?= $row->nama_lengkap ?>"><?= $row->nama_lengkap; ?></option>
                                    <?php endforeach; ?>  
                                </select>
