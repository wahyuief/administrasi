...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=BASE_URL?>" class="login-logo-title" style="color:#fff"><?=get_option('site_name')?></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="padding:25px;">
    <center> <a href="<?=BASE_URL?>"><img src="<?=base_url()?>setting/<?=get_option('logo')?>" alt="<?= get_option('site_name'); ?>" width="180"></a></center>
    <br>
