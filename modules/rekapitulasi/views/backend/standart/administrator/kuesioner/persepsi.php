...
<section class="content-header">
   <h1>
      Persepsi<small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Persepsi</li>
   </ol>
</section>
<!-- Main content -->
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username">Persepsi</h3>
                     <h5 class="widget-user-desc"><?= cclang('list_all', ['Persepsi']); ?></h5>
                  </div>
                     ...
                     <?php $jumlah_pertanyaan = count(db_get_all_data('kuesioner_pertanyaan', ['tipe'=>$tipe->id])); ?>
                        <tr>
                           ...
                           <td rowspan="<?php echo $jumlah_pertanyaan+1 ?>"><?php $hasil = array();foreach(db_get_all_data('kuesioner_pertanyaan', ['tipe'=>$tipe->id]) as $pertanyaan):
                              $sp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Sangat Puas']));
                              $p = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Puas']));
                              $cp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Cukup Puas']));
                              $tp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Tidak Puas']));
                              $stp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Sangat Tidak Puas']));
                           ...
                           <tr>
                              ...
                              <td><?php $sp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Sangat Puas']));echo $sp; ?></td> 
                              <td><?php $p = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Puas']));echo $p; ?></td> 
                              <td><?php $cp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Cukup Puas']));echo $cp; ?></td> 
                              <td><?php $tp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Tidak Puas']));echo $tp; ?></td> 
                              <td><?php $stp = count(db_get_all_data('kuesioner', ['pertanyaan'=>$pertanyaan->id,'jawaban_persepsi'=>'Sangat Tidak Puas']));echo $stp; ?></td> 
