...
/**
*| --------------------------------------------------------------------------
*| <?= ucwords($subject); ?> Controller
*| --------------------------------------------------------------------------
*| <?= ucwords($subject); ?> site
*|
*/
			...
			if ($save_{table_name}) {
				if ($this->input->post('save_type') == 'stay') {
					...
					$this->data['message'] = cclang('success_save_data_stay', [
						anchor('administrator/{table_name}/edit/' . $save_{table_name}, 'Edit <?= ucwords($subject); ?>'),
...
/* Location: ./application/controllers/administrator/<?= ucwords($subject); ?>.php */