      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="http://localhost/djki/administrator/tb_kegiatan" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="http://localhost/djki/administrator/tb_kerjasama" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="http://localhost/djki/administrator/tb_mou" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="http://localhost/djki/administrator/tb_mitra" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
     ...
     <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Grafik Kegiatan</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Pencapaian Tahunan</h3>
  ...
  $(function () {
    ...
    var donut = new Morris.Donut({
      ...
      data: [
        ...
        {label: "Dalam Progress", value: 10},
        {label: "Persiapan", value: 5},
        {label: "Tidak Hadir", value: 3}
      ],
      hideHover: 'auto'
    });
